...
export const SerchBar = () => {
  return (
    <div className="relative  w-2/3 mx-auto h-[300px]">
      <img className="w-full h-full rounded-b-2xl object-cover" src={imgPirata} alt="piratas del caribe" />
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
        ...
        <input
          className="mt-4 p-2 w-[400px] rounded-full border border-gray-400"
